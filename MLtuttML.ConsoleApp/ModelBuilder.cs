...
namespace MLtuttML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\pra\MLtutt\wikipedia-price-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\lliu\AppData\Local\Temp\MLVSTools\MLtuttML\MLtuttML.Model\MLModel.zip";
